...
// add class 'nav-link' to all anchors inside menu   
...
function enqueue_script_file() {
    wp_enqueue_script( 'index', get_template_directory_uri() . '/index.js', false );
}
...
$services = array(
    'development' => array(
        ...
        'desc' => 'Build website from scratch with custom design, fix your existing website and improve its performace or choose your own theme'
    ),
    'seo' => array(
        'name' => 'SEO',
        'icon' => '/images/suche.png',
        'desc' => 'We will make your website fast and SEO ready with the best performace to have good score in Google'
    ),
    'blog' => array(
        'name' => 'BLOG',
        'icon' => '/images/blog.png',
        'desc' => 'Take your local business online and create your website to make it easier for your clients to reach you'
    ),
    'woocommerce' => array(
        'name' => 'WOOCOMMERCE',
        'icon' => '/images/einkaufstasche.png',
        'desc' => 'Create your online shop to reach a higher volume of clients and sell your products online'
    )
    );
